...
//         (async () => {
//             model = await ml5.sketchRNN("cat", () => canvas.addEventListener("mouseup", startSketchRNN));
...
//             <canvas ref={canvasRef} height={640} width={480} onMouseMove={onMouseUpdate} onMouseDown={onMouseDown} onMouseUp={onMouseUp}></canvas>
//         </div>
//     );
// }
