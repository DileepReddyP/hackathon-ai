...
function QuestionTwo() {
	...
	return (
		<div>
			<p>
				Our numbers need to be in boxes with the <strong>same</strong> size,
			</p>
			<p>
				and we&apos;re going to use a <strong>28 x 28</strong> box for the
				numbers
			</p>
